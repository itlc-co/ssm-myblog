package org.lc.my_blog_api.generator;
...
//                            .enableSwagger()
                            // 覆盖已经生成的文件
                            .fileOverride()
                            .outputDir(projectPath + "/my_blog_api/src/main/java");
                })
                // 包名配置
                .packageConfig((scanner,builder) -> {
                    ...
                    builder
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, projectPath+"/my_blog_api/src/main/resources/mappers"));
                })
                // 策略配置
